    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-wrap">
        <div class="w-full lg:w-6/12 px-4">
          <h4 class="text-3xl font-semibold">Hubungi kami</h4>
          <h5 class="text-lg mt-0 mb-2 text-gray-700">
            Jangan ragu belajar bersama Loka Academy.
          </h5>
          <div class="mt-6">
      ...
      <div class="flex flex-wrap items-center md:justify-between justify-center">
        <div class="w-full md:w-4/12 px-4 mx-auto text-center">
          <div class="text-sm text-gray-600 font-semibold py-1">Copyright © 2023 by
            <a href="https://www.lokaacademy.com" class="text-gray-600 hover:text-gray-900">Loka Academy</a>.
          </div>
        </div>
      </div>
    </div>
